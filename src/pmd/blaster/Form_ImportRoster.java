...
{
    public Form_ImportRoster(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (ofDialog.showOpenDialog(this) == JFileChooser.APPROVE_OPTION)
            jTextField2.setText(ofDialog.getSelectedFile().getAbsolutePath());
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(Form_ImportRoster.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                Form_ImportRoster dialog = new Form_ImportRoster(new javax.swing.JFrame(), true);
